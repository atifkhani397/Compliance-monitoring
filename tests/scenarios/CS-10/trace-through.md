...
| ---: | --- | --- |
| 1 | Synthetic detection | agent-tm-001 emit predetermined rule-based results. |
...
| 6 | Report generation | Internal disciplinary report, Client notification, Regulatory referral; draft-only authorization state. |
