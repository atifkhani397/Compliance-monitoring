...
| 5 | Escalation | Tier 1 with Phase 4 SLA and decision-support package. |
| 6 | Reporting | Prospectus deviation report, Portfolio rebalancing recommendation with authorization state preserved. |
