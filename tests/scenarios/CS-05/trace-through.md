...
| ---: | --- | --- |
| 1 | Synthetic detection | agent-cs-001 emit predetermined rule-based results. |
...
| 6 | Report generation | Internal investigation report, SEC notification, Deal team isolation protocol; draft-only authorization state. |
