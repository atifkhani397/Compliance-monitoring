...
| ---: | --- | --- |
| 1 | Synthetic detection | agent-ru-001 emit predetermined rule-based results. |
...
| 5 | Escalation | Tier 1 human review with SLA. |
| 6 | Report generation | Impact assessment report, Implementation timeline, Stakeholder notification; draft-only authorization state. |
