...
| 5 | Escalation | Tier 4 with Phase 4 SLA and decision-support package. |
| 6 | Reporting | SAR filing (FinCEN), Trade finance review report, RM conduct investigation report, Sanctions screening report, Board-level executive summary with authorization state preserved. |
