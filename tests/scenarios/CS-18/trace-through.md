...
| 4 | Consensus or special handling | Documented UPDATE and suppression/regulatory-change flow. |
| 5 | Escalation | No escalation is permitted. |
| 6 | Reporting | No report generated — false-positive suppression record with authorization state preserved. |
