...
| 4 | Consensus or special handling | Type C handling. |
| 5 | Escalation | Tier 3 with Phase 4 SLA and decision-support package. |
| 6 | Reporting | Research independence violation, Global Research Settlement compliance review with authorization state preserved. |
