...
| ---: | --- | --- |
| 1 | Synthetic detection | agent-tm-001, agent-cs-001 emit predetermined rule-based results. |
...
| 5 | Escalation | Tier 3 human review with SLA. |
| 6 | Report generation | SAR filing draft (FinCEN Form 111), Internal investigation report, Regulatory notification draft (SEC); draft-only authorization state. |
