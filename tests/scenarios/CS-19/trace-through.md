...
| 4 | Consensus or special handling | Type E handling. |
| 5 | Escalation | Tier 4 with Phase 4 SLA and decision-support package. |
| 6 | Reporting | Regulatory conflict analysis, Legal opinion request, Jurisdictional compliance strategy with authorization state preserved. |
