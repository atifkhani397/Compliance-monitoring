...
| ---: | --- | --- |
| 1 | Synthetic detection | agent-cs-001, agent-tm-001 emit predetermined rule-based results. |
...
| 4 | Consensus or special handling | Type B conflict resolution. |
| 5 | Escalation | Tier 2 human review with SLA. |
| 6 | Report generation | FINRA referral, Client remediation plan, Advisor disciplinary report; draft-only authorization state. |
